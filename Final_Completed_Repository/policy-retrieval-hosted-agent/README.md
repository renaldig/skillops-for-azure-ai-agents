...
The agent is intended to answer from the approved policy index, state when evidence is unavailable, and refuse requests for individual employee records.
